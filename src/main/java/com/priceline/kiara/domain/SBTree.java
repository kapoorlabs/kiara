...
public class SBTree<T extends Comparable<T>> {
	...
	public static void main(String[] args) {
		...
		SBTree<Integer> dd = new SBTree<>();
		dd.insert(new SBTreeElement<>(10));
		dd.insert(new SBTreeElement<>(10));
		dd.insert(new SBTreeElement<>(10));
		dd.insert(new SBTreeElement<>(20));
		dd.insert(new SBTreeElement<>(10));
		dd.insert(new SBTreeElement<>(30));
		dd.insert(new SBTreeElement<>(40));
		dd.insert(new SBTreeElement<>(50));
		dd.insert(new SBTreeElement<>(25));
		dd.insert(new SBTreeElement<>(0));
		dd.insert(new SBTreeElement<>(-1));
		dd.insert(new SBTreeElement<>(15));
		dd.insert(new SBTreeElement<>(14));
		dd.insert(new SBTreeElement<>(12));
		dd.insert(new SBTreeElement<>(27));
		dd.insert(new SBTreeElement<>(25));

		System.out.println(dd.getAllBetween(-1,20));
